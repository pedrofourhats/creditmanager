...
public class PersonServiceImpl implements PersonService {
	...
	public void addPerson(PersonDTO person) {
		...
		Person newPerson = new Person(person.getName(), person.getSurname(), person.getIdentityType(), person.getIdentityNumber(), person.getBirthDate(), 
				person.getGender(), person.getPhone(), person.getWorkPhone(), person.getCellPhone(), person.getEmail(), person.getProvince(), 
				person.getLocality(), person.getAddress(), person.getAddressNumber(), person.getAddressFloor(), person.getAddressAppartment(), 
				person.getPostCode(), person.getType(), person.getActive());
	...
	public void editPerson(PersonDTO person) {
		...
		personToEdit.setActive(person.getActive());
