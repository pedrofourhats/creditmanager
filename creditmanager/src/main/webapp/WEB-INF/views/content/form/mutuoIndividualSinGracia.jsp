    ...
    <div class="panel panel-default">
		...
		<div class="panel-body" id="printableDiv">
		    <h3>
               ...
               <p class="span-inline">
                 <b>PRIMERA: Monto del Préstamo</b>. El DEUDOR recibe en este acto del ACREEDOR la suma de $ ……………….. (…………………………………….), mediante cheques del  Banco Credicoop Nº {{form.checkNumber}}, sirviendo el presente de eficaz recibo en legal forma, por lo cual el DEUDOR otorga a favor del ACREEDOR formal carta de adeudo.
                 <br>
