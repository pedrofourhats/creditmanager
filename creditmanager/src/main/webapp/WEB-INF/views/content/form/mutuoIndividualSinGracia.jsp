  ...
  <div class="container forms-list" ng-controller="formController">
    <div class="panel panel-default">
		...
		<div class="panel-body" id="printableDiv">
		    <h3>
                 Contrato de mutuo entre EL POLO TECNOLÓGICO CONSTITUYENTES S.A., en su calidad de FIDUCIARIO del FIDEICOMISO SALTO GRANDE, celebrado el 10 de Junio de 2005,  y <span class="uppercase">{{project.holders[0].name}} {{project.holders[0].surname}}</span> 
               </h3>
               <p class="mt10">
               ...
               <p class="span-inline">
                 ...
                 <br>
                 <b>DECIMA: Acerca de las Garantías</b>. El DEUDOR ofrece en garantía los Contratos de Fianza del/la Sr./Sra. {{project.guarantors[0].name}} {{project.guarantors[0].surname}} con DNI Nº {{project.guarantors[0].identityNumber}} y del/la Sr./Sra. {{project.guarantors[1].name}} {{project.guarantors[1].surname}} con DNI Nº {{project.guarantors[1].identityNumber}}  emitidos en beneficio del ACREEDOR, respecto de las obligaciones por el asumidas en este Contrato de Mutuo, el que exhibe en este acto y cuya copia se agrega como Anexo II, y declara conocer y consentir, además, el contrato de mutuo suscripto el __________, entre el ACREEDOR y el FONCAP S.A., que se integra al presente contrato y se adjunta como anexo I. El DEUDOR, dará cumplimiento a las cargas y obligaciones contenidas en los referidos instrumentos que pesan sobre el ACREEDOR, así como se somete al régimen de causales de rescisión allí contenidas y a los efectos pactados, por su acción u omisión.
                 <br>
               ...
               <div class="row txtC signature">
                  ...
                  <div class="col-sm-4">
                    Firma del CODEUDOR
                    <hr>
                    <span class="uppercase">{{project.guarantors[0].name}} {{project.guarantors[0].surname}}</span>  
                    <br>
                  ...
                  <div class="col-sm-4">
                    Firma del CODEUDOR
                    <hr>
                    <span class="uppercase">{{project.guarantors[1].name}} {{project.guarantors[1].surname}}</span> 
                    <br>
