    ...
    <div class="panel panel-default">
      <div class="panel-body">
		...
		{{project.holders[0].identityNumber}}
                ...
                <p class="mt10">
                  Entre el POLO TECNOLÓGICO CONSTITUYENTES S.A. en su calidad de administrador FIDUCIARIO del contrato de fideicomiso que hubiere celebrado en fecha 10 de junio de 2005 con la Comisión Administradora para el Fondo Especial de Salto Grande, representado por su apoderado para este acto CPN Elina Gabriela Buffa, titular del DNI Nº 25.511.090 con domicilio en Paraná 145 Piso 4º, de la Ciudad Autónoma de Buenos Aires, en adelante el ACREEDOR, y por otra parte NOMBRETITULARPROYECTO con DNI Nº DNIETITULARPROYECTO. con domicilio en la calle DOMICIOLIOTITULARPROYETO, Departamento de DEPARTAMENTOTITULARPROYECTO, Provincia de Entre Ríos, en adelante el DEUDOR, se celebra el presente contrato de MUTUO, el que se sujetará a las siguientes cláusulas:
                </p>
                <p class="span-inline">
                  <b>PRIMERA: Monto del Préstamo</b>. El DEUDOR recibe en este acto del ACREEDOR la suma de $ IMPORTEOTORGADOALPROYECTO. (IMPORTEOTORGADOENPALABRAS), mediante cheques del  Banco Credicoop Nº DATODELFORMULARIO_NCHEQUE, sirviendo el presente de eficaz recibo en legal forma, por lo cual el DEUDOR otorga a favor del ACREEDOR formal carta de adeudo.
                  <br>
                  ...
                  <br>
                  <b>DECIMA: Acerca de las Garantías</b>. El DEUDOR ofrece en garantía los Contratos de Fianza de la Sr/a GARANTE1 con DNI N° DNIGARANTE1 y del Sr./a GARANTE2 con DNI N° DNIGARANTE2 emitidos en beneficio del ACREEDOR, respecto de las obligaciones por el asumidas en este Contrato de Mutuo, el que exhibe en este acto y cuya copia se agrega como Anexo II, y declara conocer y consentir, además, el contrato de mutuo suscripto el 17/08/2005, entre el ACREEDOR y el FONCAP S.A., que se integra al presente contrato y se adjunta como anexo I. El DEUDOR, dará cumplimiento a las cargas y obligaciones contenidas en los referidos instrumentos que pesan sobre el ACREEDOR, así como se somete al régimen de causales de rescisión allí contenidas y a los efectos pactados, por su acción u omisión.
                  <br>
