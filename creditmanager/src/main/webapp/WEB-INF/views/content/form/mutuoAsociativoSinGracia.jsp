      ...
      <div class="panel-body">
		<div class="panel-body">
			...
			<label for="years">Año: </label><input type="text" id="year" ng-model="year" class="form-control"> 
                ...
                <p class="span-inline">
                  <b>PRIMERA: Monto del Préstamo</b>. El DEUDOR recibe en este acto del ACREEDOR la suma de $...................- (.......................), mediante cheque del  Banco Credicoop Nº {{checkNumber}}, sirviendo el presente de eficaz recibo en legal forma, por lo cual el DEUDOR otorga a favor del ACREEDOR formal carta de adeudo.
                  <br>
