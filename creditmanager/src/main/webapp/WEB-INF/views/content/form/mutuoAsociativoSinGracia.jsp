  ...
  <div class="container forms-list" ng-controller="formController">
    <div class="panel panel-default">
		...
		<div class="panel-body" id="printableDiv">
               <h3>
                 Contrato de mutuo entre EL POLO TECNOLÓGICO CONSTITUYENTES S.A., en su calidad de FIDUCIARIO del FIDEICOMISO SALTO GRANDE, celebrado el 10 de Junio de 2005,  y ................................ y ...............................                
               </h3>
               <p class="mt10">
                 Entre el POLO TECNOLÓGICO CONSTITUYENTES S.A. en su calidad de administrador FIDUCIARIO del contrato de fideicomiso que hubiere celebrado en fecha 10 de junio de 2005 con la Comisión Administradora para el Fondo Especial de Salto Grande, representado por su apoderado para este acto CPN Elina Gabriela Buffa, titular del DNI Nº 21.511.090 con domicilio en Paraná 145 Piso 4º, de la Ciudad Autónoma de Buenos Aires, en adelante el ACREEDOR, y por otra parte {{project.holders[0].name}} {{project.holders[0].surname}} con DNI Nº {{project.holders[0].identityNumber}} con domicilio en la calle {{project.holders[0].address}} , Departamento de {{project.holders[0].locality}} , Provincia de Entre Ríos, en adelante el DEUDOR, se celebra el presente contrato de MUTUO, el que se sujetará a las siguientes cláusulas:
               </p>
               <p class="span-inline">
                 <b>PRIMERA: Monto del Préstamo</b>. El DEUDOR recibe en este acto del ACREEDOR la suma de {{project.givenAmount}} ({{project.givenAmount}}), mediante cheques del  Banco Credicoop Nº {{form.checkNumber}}, sirviendo el presente de eficaz recibo en legal forma, por lo cual el DEUDOR otorga a favor del ACREEDOR formal carta de adeudo.
                 <br>
                 <b>SEGUNDA: Amortización</b>. El  DEUDOR  se  obliga a pagar al ACREEDOR el total del préstamo que asciende a {{project.givenAmount}} ({{project.givenAmount}}) con más una tasa de interés mensual variable, que se establecerá sobre las bases estipuladas en la cláusula 9 del contrato de mutuo suscripto entre el FONCAP S.A. y el ACREEDOR, que el DEUDOR declara conocer y forma parte del presente contrato como Anexo I, en {{project.givenDeadline}} períodos mensuales y consecutivos, correspondientes a la deuda de capital,  otorgándose un plazo de gracia de {{project.requestedGracePeriod}} días para la devolución del capital a contar desde el momento de desembolso por parte de FONCAP, en el lugar y tiempo que indique el  ACREEDOR. En tal sentido, el DEUDOR comenzara a pagar las cuotas de los primeros servicios correspondientes a la atención de los intereses el día {{project.deliveryDate}} según consta en el cronograma de pago, entregado a la firma del presente contrato o al día hábil inmediato posterior en el caso que este fuera inhábil. A partir del {{project.deliveryDate}}, el DEUDOR comenzará a pagar conjuntamente los {{project.deliveryDate}} de cada mes las cuotas en concepto de capital e intereses de los meses sucesivos a la atención de los intereses o al día hábil inmediato posterior si estos fueran inhábiles.
                 <br>
                 ...
                 <br>
                 <b>DECIMA: Acerca de las Garantías</b>. El DEUDOR ofrece en garantía los Contratos de Fianza del/la Sr./Sra. {{project.guarantors[0].name}} {{project.guarantors[0].surname}} con DNI Nº {{project.guarantors[0].identityNumber}} y del/la Sr./Sra. {{project.guarantors[1].name}} {{project.guarantors[1].surname}} con DNI Nº {{project.guarantors[1].identityNumber}}  emitidos en beneficio del ACREEDOR, respecto de las obligaciones por el asumidas en este Contrato de Mutuo, el que exhibe en este acto y cuya copia se agrega como Anexo II, y declara conocer y consentir, además, el contrato de mutuo suscripto el 17/08/2005, entre el ACREEDOR y el FONCAP S.A., que se integra al presente contrato y se adjunta como anexo I. El DEUDOR, dará cumplimiento a las cargas y obligaciones contenidas en los referidos instrumentos que pesan sobre el ACREEDOR, así como se somete al régimen de causales de rescisión allí contenidas y a los efectos pactados, por su acción u omisión.
                 <br>
               ...
               <div class="row txtC signature">
                  ...
                  <div class="col-sm-3">
                    Firma del DEUDOR 
                    <hr>
                    {{project.holders[1].surname}}, {{project.holders[1].name}} 
                    <br>
                    DNI Nº: {{project.holders[1].identityNumber}}
                  </div>
                  <div class="col-sm-3">
                    Firma del CODEUDOR
                    <hr>
                  ...
                  <div class="col-sm-3">
                    Firma del CODEUDOR
                    <hr>
                    {{project.guarantors[1].surname}}, {{project.guarantors[1].name}} 
                    <br>
                 ...
                 <div class="col-sm-offset-3 col-sm-6 mt30">
                   ...
                   <hr>
                   Por poder <b>CPN Elina Gabriela Buffa</b>
                   <br>
                   DNI Nº: 25.511.090
                 </div>
