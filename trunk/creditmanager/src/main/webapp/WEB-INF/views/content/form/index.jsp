          ...
          <div class="panel panel-default">
            ...
            <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style="height: 0px;">
              <div class="panel-body">
                ...
                <p class="span-inline">
                  <b>PRIMERA: Monto del Préstamo</b>. El DEUDOR recibe en este acto del ACREEDOR la suma de $ 30.000 (pesos treinta mil), mediante cheques del  Banco Credicoop Nº <input type="text" name="num-cheque" class="form-control"> sirviendo el presente de eficaz recibo en legal forma, por lo cual el DEUDOR otorga a favor del ACREEDOR formal carta de adeudo.
                  <br>
                  <b>SEGUNDA: Amortización</b>. El  DEUDOR  se  obliga a pagar al ACREEDOR el total del préstamo que asciende a $ 30.000 (pesos treinta mil) con más una tasa de interés mensual variable, que se establecerá sobre las bases estipuladas en la cláusula 9 del contrato de mutuo suscripto entre el FONCAP S.A. y el ACREEDOR, que el DEUDOR declara conocer y forma parte del presente contrato como Anexo I, en 27 períodos mensuales y consecutivos, correspondientes a la deuda de capital, otorgándose un plazo de gracia de 90 días para la devolución del capital a contar desde el momento de desembolso por parte de FONCAP, en el lugar y tiempo que indique el  ACREEDOR. En tal sentido, el DEUDOR comenzara a pagar las cuotas de los primeros servicios correspondientes a la atención de los intereses el día 15 del Julio según consta en el cronograma de pago, entregado a la firma del presente contrato o al día hábil inmediato posterior en el caso que este fuera inhábil. A partir del 15 de Octubre del 2014, el DEUDOR comenzará a pagar conjuntamente los 15 de cada mes las cuotas en concepto de capital e intereses de los meses sucesivos a la atención de los intereses o al día hábil inmediato posterior si estos fueran inhábiles.
                  <br>
                  ...
                  <br>
                  <b>DECIMA: Acerca de las Garantías</b>. El DEUDOR ofrece en garantía los Contratos de Fianza del Sr./ Sra. Ratto, Carlos Ignacio con DNI N° 16.327.318 y del Sr./Sra. Rodriguez Claro, Walter Sebastían con DNI N° 33.422.763 emitidos en beneficio del ACREEDOR, respecto de las obligaciones por el asumidas en este Contrato de Mutuo, el que exhibe en este acto y cuya copia se agrega como Anexo II, y declara conocer y consentir, además, el contrato de mutuo suscripto el 17/08/2005, entre el ACREEDOR y el FONCAP S.A., que se integra al presente contrato y se adjunta como anexo I. El DEUDOR, dará cumplimiento a las cargas y obligaciones contenidas en los referidos instrumentos que pesan sobre el ACREEDOR, así como se somete al régimen de causales de rescisión allí contenidas y a los efectos pactados, por su acción u omisión.
                  <br>
                  ...
                  <br>
                  <b>DÉCIMO SEGUNDA: Codeudores</b>. El Sr./ La Sra. Ratto, Carlos Ignacio con DNI Nº 16.327.318 con domicilio en la calle 8 de Junio N° 953 y el Sr./ la Sra. Rodriguez Claro, Walter Sebastían con DNI N° 33.422.763 con domicilio en calle 15 del Norte N° 1.413, de la Ciudad de Concepción del Uruguay, Provincia de Entre Ríos, se constituyen en codeudores solidarios, fiadores lisos y llanos, principales pagadores del DEUDOR respecto del cumplimiento de todas y cada una de las obligaciones asumidas en este contrato frente al ACREEDOR, por lo cual este último podrá requerirle el cumplimiento de la totalidad de las obligaciones asumidas por el DEUDOR, no pudiendo invocar los beneficios de excusión  y/o división.
                  <br>
                ...
                <div class="row txtC signature">
                  ...
                  <div class="col-sm-4">
                    Firma del CODEUDOR
                    <hr>
                    Rodriguez Claro, Walter Sebastían
                    <br>
                    DNI Nº: 33.422.763
                  </div>
