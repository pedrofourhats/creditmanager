    ...
    <div class="panel panel-default">
		...
		<div class="panel-body" id="printableDiv">
                ...
                <p class="span-inline">
                  ...
                  <br>
                  <b>DECIMA:</b> El DEUDOR ofrece en garantía los Contratos de Fianza del/la Sr./Sra. {{project.guarantors[0].name}} {{project.guarantors[0].surname}} con DNI Nº {{project.guarantors[0].identityNumber}} y del/la Sr./Sra. {{project.guarantors[1].name}} {{project.guarantors[1].surname}} con DNI Nº {{project.guarantors[1].identityNumber}}  emitidos en beneficio del ACREEDOR, respecto de las obligaciones por el asumidas en este Contrato de Mutuo, el que exhibe en este acto y cuya copia se agrega como Anexo II, y declara conocer y consentir, además, el contrato de mutuo suscripto el 17/08/2005, entre el ACREEDOR y el FONCAP S.A., que se integra al presente contrato y se adjunta como anexo I. El DEUDOR, dará cumplimiento a las cargas y obligaciones contenidas en los referidos instrumentos que pesan sobre el ACREEDOR, así como se somete al régimen de causales de rescisión allí contenidas y a los efectos pactados, por su acción u omisión.
                  <br>
