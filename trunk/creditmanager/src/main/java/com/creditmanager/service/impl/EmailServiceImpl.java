...
import com.creditmanager.service.EmailService;
...
public class EmailServiceImpl implements EmailService {
	...
	private static final String emailPath = "/home/latiend/www/emails/";
	
	public void sendEMail(String recipient, String subject, String emailName, Map<String, String> values) throws MessagingException, AuthenticationFailedException { 
		String[] recipients = { recipient };
		this.sendEMail(recipients, subject, emailName, values);
	}
	
	public void sendEMail(String recipients[], String subject, String emailName, Map<String, String> values) throws MessagingException, AuthenticationFailedException { 
